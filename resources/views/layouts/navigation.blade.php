    ...
    <div class="flex-1 bg-gray-100 dark:bg-gray-900">
        ...
        <header class="bg-white dark:bg-gray-800 shadow-sm relative">
            <div class="max-w-7xl mx-auto py-4 px-4 sm:px-6 lg:px-8 flex justify-between items-center">
                <!-- Page Title (Mobile Adjusted) -->
                <div class="text-lg font-semibold text-gray-800 dark:text-gray-200 ml-8 sm:ml-0 order-1 sm:order-1">
                    {{ __('Dashboard') }}
                </div>
                ...
                <!-- Settings Dropdown -->
                <div class="relative order-2 sm:order-2">
