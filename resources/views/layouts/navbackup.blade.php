<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <!-- Admin Link -->
            @if (Auth::user()->usertype == 'admin')
                <x-responsive-nav-link href="admin/pengajuan" :active="request()->routeIs('admin.pengajuan')">
                    {{ __('Pengajuan') }}
                </x-responsive-nav-link>
                <x-responsive-nav-link href="admin/karya" :active="request()->routeIs('admin.karya')">
                    {{ __('Karya') }}
                </x-responsive-nav-link>
                <x-responsive-nav-link href="admin/akun" :active="request()->routeIs('admin.akun')">
                    {{ __('Akun') }}
                </x-responsive-nav-link>
            @endif

            @if (Auth::user()->usertype == 'mahasiswa')
                <x-responsive-nav-link href="mahasiswa/pengajuan" :active="request()->routeIs('mahasiswa.pengajuan')">
                    {{ __('Pengajuan') }}
                </x-responsive-nav-link>
                <x-responsive-nav-link href="mahasiswa/karya" :active="request()->routeIs('mahasiswa.karya')">
                    {{ __('Karya Saya') }}
                </x-responsive-nav-link>
