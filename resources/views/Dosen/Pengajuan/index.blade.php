        ...
        <div class="flex-1 bg-gray-100 dark:bg-gray-900">
            ...
            <main>
                <div class="container">
                    ...
                    <a href="{{ route('dosen.pengajuan.create') }}" class="bg-blue-500 text-white px-4 py-2 rounded">Buat
                        Pengajuan</a>
                    ...
                    <table class="min-w-full mt-4 border border-gray-300">
                        ...
                        <tbody>
                            @foreach ($pengajuanList as $pengajuan)
                                <tr>
                                    <td class="border border-gray-300 px-4 py-2">{{ $pengajuan->karya->judul }}</td>
                                    ...
                                    <td class="border border-gray-300 px-4 py-2">
                                        ...
                                        <form action="{{ route('dosen.pengajuan.destroy', $pengajuan->id) }}"
